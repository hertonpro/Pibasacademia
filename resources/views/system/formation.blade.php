                                ...
                                <div class="hk-row">
                                    @foreach ($coursid as $cours)
                                        ...
                                        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4  ">
                                            ...
                                            <span class="badge badge-info  badge-sm">Fin le {{substr($cours->datecours, 12, 20)}}</span>
                                        ...
                                        <form action="{{url('/suivrecours')}}" methode="get">
                                            ...
                                            <input type="hidden" value="{{$cours->cours_id}}" name="cours_id" id="cours_id">
                                            <input type="hidden" value="0" name="status" id="status">
                                                <button type="submit" class="badge badge-soft-info btn btn-sm btn btn-gradient-danger pull-right">suivre</button>
                                            </form>
                                        </div>
                                    @endforeach
                        ...
                        <div class="dd" id="nestable2">
                            <ol class="dd-list">
                                ...
                                <li class="dd-item dd3-item" data-id="1">
                                    ...
                                    <div class="dd3-content"> <a href="{{$itemitem->link}}" target="_blank">{{$itemitem->description}}</a> </div>
                                </li>
                                @endforeach
                            </ol>
                        </div>
                                ...
                                function saved(){
                                    ...
                                    var cours_id=$('#cours_id').val();
                                        $.ajax({
                                                method : "POST",
                                                url: "{{url('suivrecours')}}",
                                                data: {user_id:user_id,cours_id:cours_id},
                                                success: function(dt){
                                                    window.open("{{url('forma/')}}"+user_id);
                                        }
                                    });
                                }
