    ...
    <div class="row">
        <div class="col-8  card">
                ...
                <div class="card">
                    ...
                    <div><span class="text-dark">Créé le </span>{{date($item->created_at)}}</div>
                        <a class="btn btn-xs btn-info ml-15 w-sm-100p" href="{{url('article', $item->id)}}"><small class="text-muted">+ Plus</small></a>
                    </div>
                </div>
                @endforeach
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" role="tabpanel">
                            ...
                            <div class="row hk-gallery">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-6 mb-10" data-src="{{ asset('storage/'.$itemart->img) }}">
                                    <a href="#" class="">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item border-0">
                        <div class="media align-items-center">
                            <div class="d-flex media-img-wrap mr-15">
                                <div class="avatar avatar-sm">
                                    <img src="{{ asset('dist\img\logo.png') }}" alt="user" class="avatar-img rounded-circle">
                                </div>
                            </div>
                            <div class="media-body">
                                <a href="{{url('forma', $itemrecent->formation_id)}}">
                                    <span class="d-block text-dark text-capitalize">{{  substr($itemrecent->titre, 0,15).'...'  }}</span>
                                </a>
                                <span class="d-block font-13">{{  substr($itemrecent->titre, 1,20).'...'  }}</span>
                            </div>
                        </div>
