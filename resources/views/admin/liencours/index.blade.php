...
<div class="table-wrap">
    <table id="datable_3" class="table table-hover w-100 display dataTable no-footer dtr-inline" role="grid"
        style="width: 1040px;">
        ...
        <tbody> @php
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ URL('liencours/edit/'. $liencours->liencours_id)}}"
                        class="btn btn-primary btn-sm">Edit</a>
                    <form action="{{ URL('liencours/destroy/'.  $liencours->liencours_id )}}" method="post"
