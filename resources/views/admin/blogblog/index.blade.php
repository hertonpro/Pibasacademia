                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="table-wrap">
                            <table id="" class="table table-hover w-100 display dataTable no-footer dtr-inline"
                                role="grid" style="width: 1040px;">
                                <thead>
                                        ...
                                        <td>
                                            ...
                                            <div class="embed-responsive embed-responsive-16by9">
                                                <iframe class="embed-responsive-item"
                                                    src="{{ asset('blogsfiles/'.$blogs->fichier) }}"></iframe>
                                                @else

                                                @endif
                                        </td>
                                        <td class="text-center">
                                            <a href="/blogs/{{ $blogs->blog_id }} /edit"
                                                class="btn btn-primary btn-sm">Edit</a>
                                            <form action="/blogs/destroy/{{ $blogs->blog_id }}" method="post"
