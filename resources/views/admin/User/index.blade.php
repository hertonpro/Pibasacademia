                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <table id=""
                                            class="table table-hover w-100 display dataTable no-footer dtr-inline"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('aproposs.edit', $aproposs->apropos_id)}}"
                                                            class="btn btn-primary btn-sm">Edit</a>
                                                        <form
                                                            action="{{ route('aproposs.destroy',  $aproposs->apropos_id )}}"
