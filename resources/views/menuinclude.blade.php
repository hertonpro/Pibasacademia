    ...
    <div class="collapse navbar-collapse" id="navbarSupportedColor1">
        ...
        <ul class="navbar-nav align-items-center flex-row">
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/home') }}"><i class="font-22 zmdi s">Connexion</i></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="font-22 zmdi zmdi-notifications"></i></a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link d-flex align-items-center dropdown-toggle no-caret" href="#" id="userAuthdrpColor1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
